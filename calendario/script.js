...
currentMonth.textContent = date.toLocaleDateString("pr-BR", {month:'long', year:'numeric'});
...
document.querySelectorAll(".month-btn").forEach(function (element) {
	element.addEventListener("click", function () {
		...
		currentMonth.textContent = date.toLocaleDateString("pt-BR", {month:'long', year:'numeric'});
		renderCalendar();
	});
});
